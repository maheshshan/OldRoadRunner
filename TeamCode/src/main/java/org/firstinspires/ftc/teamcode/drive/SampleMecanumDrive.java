...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(5, 0, .8);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(6.0, 0, 0);

    public static double LATERAL_MULTIPLIER = 60.0/59.2407;
...
/*        imu = hardwareMap.get(IMU.class, "imu");
        ...
        Servo tiltIntake = hardwareMap.get(Servo.class, "tiltIntake");

        tiltIntake.setPosition(0.045);
