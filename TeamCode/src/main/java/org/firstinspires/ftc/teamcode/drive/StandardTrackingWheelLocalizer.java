...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double FORWARD_OFFSET = -1.45; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 100.0/100.5;
    public static double Y_MULTIPLIER = 100.0/101.0;
